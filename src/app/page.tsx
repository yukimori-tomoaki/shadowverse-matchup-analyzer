...
import { filterMatches, getDecks, getMyDecks, getOpponentDecks } from "@/lib/matchupCalculator";
...
export default function Home() {
  ...
  const myDecks = useMemo(() => getMyDecks(filteredRecords), [filteredRecords]);
  const opponentDecks = useMemo(() => getOpponentDecks(filteredRecords), [filteredRecords]);
