...
import { filterMatches, getDecks, getMatrixDecks } from "@/lib/matchupCalculator";
...
export default function Home() {
  ...
  const matrixDecks = useMemo(() => getMatrixDecks(filteredRecords), [filteredRecords]);
