...
import { getMyDecks, getOpponentDecks } from "@/lib/matchupCalculator";
...
export default function PublicBoardPage() {
  ...
  const myDecks = useMemo(() => getMyDecks(records), [records]);
  const opponentDecks = useMemo(() => getOpponentDecks(records), [records]);
