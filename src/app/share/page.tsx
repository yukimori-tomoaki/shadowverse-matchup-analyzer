...
import { getMatrixDecks } from "@/lib/matchupCalculator";
...
export default function PublicBoardPage() {
  ...
  const decks = useMemo(() => getMatrixDecks(records), [records]);
